...
!!! ms-abstract ""
    系统主要针对系统级别的管理配置功能。目前，MeterSphere 内置三级租户体系。平台默认用户组划分为：<br>

    - **系统用户组**：系统管理员、系统成员。<br>
    - **组织用户组**：组织管理员、组织成员。<br>
    - **项目用户组**：项目管理员、项目成员。<br>
    系统的用户权限【系统设置-系统-用户组】功能页面中自定义，系统预置管理员角色权限不可编辑修改。

## 1 用户
!!! ms-abstract ""
    点击左侧【系统设置-系统-用户】进入用户管理界面。默认显示当前系统中的全部用户列表，可以对用户进行【创建用户】【邮箱邀请】【导入用户】【修改用户组】【查询】【编辑】【重置密码】【禁用】【删除】等操作。</br>MeterSphere 部署成功后会自动创建一个系统管理员账户，用户名为 admin，默认密码为 metersphere。如将平台用于生产环境，请及时更改密码。
![!用户管理](../../img/system_management/系统用户.png){ width="900px" }

!!! ms-abstract ""

    - **创建用户**<br>
    点击【创建用户】按钮创建用户，在弹出页面中编辑用户信息，默认为系统成员。可以批量添加用户并设置用户组权限，保存后添加为平台用户。注意：初始密码为邮箱地址。
![!创建用户](../../img/system_management/新增用户.png){ width="900px" }

!!! ms-abstract ""
    - **邮箱邀请**<br>
    支持通过邮箱邀请用户，可填写多个邮箱地址，默认为系统成员，可以编辑修改用户权限。点击【发送邮件】按钮，系统将批量发送邮件，邀请给用户自主注册账号密码信息登录MeterSphere平台。<br>
    注意：使用该功能需要提前在【系统设置-系统-系统参数：邮件设置】提前配置上可用的SMTP邮件信息。
![!创建用户](../../img/system_management/邮箱邀请.png){ width="900px" }

!!! ms-abstract ""
    - **导入用户**<br>
    需要批量导入用户时，可点击【导入用户】按钮，下载模版并填写用户信息，通过 Excel 文件导入用户。
![!创建用户](../../img/system_management/导入用户.png){ width="900px" }


!!! ms-abstract ""
    - **编辑用户信息**<br>
    直接点击列表【用户组】可以直接修改用户组信息。  <br>
    点击列表【编辑】可以修改用户信息，可编辑内容用户基础信息及权限。
![!设置用户角色](../../img/system_management/编辑用户1.png){ width="900px" }
![!设置用户角色](../../img/system_management/编辑用户2.png){ width="900px" }


!!! ms-abstract ""

    - **查询用户**<br>
    用户列表右上方搜索框，可根据姓名、邮箱、收集查询用户。
![针对用户的其他操作](../../img/system_management/用户查询.png){ width="900px" }

!!! ms-abstract ""

    - **用户批量操作**<br>
    用户列表多选数据，可批量对用户进行【添加至项目】【添加至用户组】【添加至组织】【重置密码】【禁用】【启用】 【删除】操作。<br>
![针对用户的其他操作](../../img/system_management/用户批量操作.png){ width="900px" }

!!! ms-abstract ""
    - **用户更多操作**<br>
    在用户列表右侧操作列，可以点击【...】可以【重置密码】为初始邮箱密码，支持【禁用】【删除】用户操作。<br>
    点击【设置】图标，可以对用户列表展示条数，列表字段排序做调整。
![针对用户的其他操作](../../img/system_management/用户其他操作.png){ width="900px" }
![针对用户的其他操作](../../img/system_management/用户列表设置.png){ width="900px" }
...
## 2 用户组
!!! ms-abstract ""
    点击左侧【系统设置-系统-用户组】菜单进入用户组界面。用户可基于自身需求创建自定义用户组，并赋予用户组不同的权限设置。系统预置管理员角色权限不可编辑，系统预置角色不可删除，内容如下：</br>
...
!!! ms-abstract ""
    ...
    - **创建用户组**<br>
    系统管理员可以对系统、组织、项目模块点击【+】按钮添加自定义用户组，可以勾选配置平台用户访问菜单权限，点击【保存】按钮保存勾选的权限配置。点击【恢复默认】按钮可恢复为上一次保存的权限。<br>
...
![编辑用户组信息](../../img/system_management/搜索用户组.png){ width="900px" }
...
### 3.1 组织
!!! ms-abstract ""
    点击左侧【系统设置-系统-组织与项目】菜单进入组织与项目管理界面。右侧默认显示当前系统中的【组织】页签，可以切换为【项目】页签。组织管理列表可对组织进行【查询】【编辑】【添加成员】【结束】【删除】等操作。<br>
    注意：社区版只可使用一个组织，且不可删除默认组织。
...
!!! ms-abstract ""
    ...
    - **添加成员**<br>
    点击【添加成员】【列表成员数组】按钮均可给当前组织添加成员用户。
![!删除工作空间](../../img/system_management/组织添加成员.png){ width="900px" }

!!! ms-abstract ""

    - **结束组织**<br>
    点击【结束】按钮，结束组织不展示在组织切换列表。
![!删除工作空间](../../img/system_management/结束组织.png){ width="900px" }

### 3.2 项目
!!! ms-abstract ""
    【系统设置-系统-组织与项目】界面，右侧页签切换为【项目】页签，进入项目管理界面。
    可以对项目做【新增】【查询】【编辑】【添加成员】【结束】【删除】操作
...
![!删除工作空间](../../img/system_management/组织项目添加项目成员.png){ width="900px" }

!!! ms-abstract ""

    - **结束项目**<br>
    点击【结束】按钮，结束项目不展示在项目切换列表。
![!删除工作空间](../../img/system_management/结束项目.png){ width="900px" }

!!! ms-abstract ""

    - **删除项目**<br>
    点击【删除】按钮，删除项目系统会在 30天 后执行删除项目，可以撤销删除状态。
![!删除工作空间](../../img/system_management/删除项目.png){ width="900px" }
...
!!! ms-abstract ""
    ...
    基本信息：设置平台站点URL。平台接口测试执行过程中 资源池 节点需要通过配置的【当前站点URL】下载 JMX 等测试资源文件。URL 值一般为通过浏览器访问 MeterSphere 的地址。</br>
    【邮件设置】：设置SMTP邮件信息，用户邮箱邀请用户，测试消息推送。</br>
    【内存清理】：可以设置系统日志保留时长，定时每天0点定时清理。</br>
...
!!! ms-abstract ""
    - **邮件配置**<br>
    点击【邮件配置】按钮，填写SMTP邮件配置基础信息，可以测试链接，链接通过即可使用。
...
## 5 资源池
!!! ms-abstract ""
    点击左侧【系统设置-系统-资源池】资源池界面。测试资源池主要用于接口测试。页面左上角可以【查询】资源池；点击【编辑】按钮更改资源池信息，点击【删除】按钮删除选定资源池。<br>
    注意：社区版不可新建资源池，可在编辑页面可以添加node节点。不可删除默认资源池。
...
!!! ms-abstract ""
    ...
    点击【编辑】按钮，在弹出的界面中为资源池名称、描述、站点URL、应用组织、用途、类型、添加资源池方式等相关信息，类型默认选择【Node】，填写相应的配置 ip 端口信息，并支持设定资源池最大并发数量或最大线程数量。<br>
    资源池支持单个添加和使用yaml批量添加两种方式。
![!创建资源池](../../img/system_management/资源池编辑.png){ width="900px" }

## 6 授权
!!! ms-abstract ""
    点击左侧【系统设置-系统-授权】进入授权管理界面，点击【授权验证】导入企业版证书license，开启 X-Pack 功能。
...
## 7 日志
!!! ms-abstract ""
    点击左侧【系统设置-系统-日志】进入日志界面，显示登录用户权限范围内的全部测试资源日志信息，并支持使用高级查询来快速查找相关日志。
...
## 9 插件
!!! ms-abstract ""
    点击左侧【系统设置-系统-插件】进入插件管理界面，MeterSphere v3.0 LTS 版本支持 DevOps、API 导入、请求、项目管理、协议 类型的插件。支持按应用场景、插件名称查询。
![插件](../../img/system_management/插件.png){ width="900px" }

!!! ms-abstract ""
    - **上传插件**<br>
    进入下载地址：https://github.com/metersphere 下载需要使用的且和当前MeterSphere版本对应的插件 jar 包。
    点击【上传插件】按钮，上传插件 jar 包，支持配置插件使用组织范围、描述。
    ![插件](../../img/system_management/上传插件.png){ width="900px" }

!!! ms-abstract ""
    - **编辑插件**<br>
    列表点击【编辑】按钮修改插件 jar 配置，支持更新插件使用组织范围、描述。
    ![插件](../../img/system_management/更新插件.png){ width="900px" }

!!! ms-abstract ""
    - **禁用插件**<br>
    列表点击【禁用】按钮禁用当前使用插件。
    ![插件](../../img/system_management/禁用插件.png){ width="900px" }
