...
## 1 成员
!!! ms-abstract ""
    点击左侧【系统设置-组织-成员】进入成员管理界面，查看当前组织的所有成员信息。
![工作空间](../../img/system_management/组织成员.png){ width="900px" }

!!! ms-abstract "操作说明"
    【添加成员】：添加组织成员并设置用户组权限。可根据用户 ID 和用户邮箱搜，勾选添加多个成员。</br>
    【查询】：按姓名、邮箱、手机来模糊查询成员信息，输入查询信息。</br>
    【修改用户组】：直接点击列表用户组快速修改用户组信息。</br>
    【编辑】：点击【编辑】按钮，可对当前成员所属项目和用户组权限做修改。</br>
    【移除】：点击【移除】按钮，当前用户失去组织的访问权限。</br>


## 2 用户组
!!! ms-abstract ""
    点击左侧【系统设置-组织-用户组】菜单进入组织用户组管理界面。点击【+】按钮用户基于自身需求创建自定义用户组，赋予用户组不同的权限设置。</br>系统预置组织管理员、组织成员角色且不可删除。组织管理员权限默认不可编辑。
![系统用户组首页](../../img/system_management/组织用户组.png){ width="900px" }

!!! ms-abstract "操作说明"
    【查询】：列表左上方，使用搜索框，根据名称查询用户组。</br>
    【编辑权限】：选择用户组，勾选用户组可访问的菜单权限编辑，点击【保存】按钮生效，点击【恢复默认】按钮可恢复为上一次保存的权限。</br>
    【添加成员】：选中用户组【+】快捷添加成员。</br>
    【删除用户组】：点击【...】选择删除用户组。</br>
    【重命名用户组】：点击【...】选择重命名用户组。</br>

!!! ms-abstract ""
    - **添加用户组成员**<br>
    选择用户组切换【成员】页面，可批量勾选成员【快速添加成员】，支持【移除】成员操作。
![系统用户组首页](../../img/system_management/添加组织用户组成员.png){ width="900px" }

## 3 项目

!!! ms-abstract ""
    点击右侧菜单【系统设置-组织-项目】进入项目管理界面。展示组织所有项目。
    
![!项目](../../img/system_management/组织的项目.png){ width="900px" }

!!! ms-abstract "操作说明"
    【查询】：列表右上方，使用搜索框，根据 ID、名称查询项目。</br>
...
!!! ms-abstract "操作说明"
    ...
    【开启模块】：默认权限，可以自定义选择。存在取消选择的模块时，已产生数据保留，但是无入口进入对应模块。</br>
...
## 4 服务集成
!!! ms-abstract ""
    查看当组织集成的缺陷管理平台，编辑当前组织对接的第三方的管理平台配置信息。服务集成列表默认展示当前组织已集成的缺陷管理平台，点击【展开】服务集成使用指引，按指引步骤下载并配置插件。<br/>
...
!!! ms-abstract ""
    第三步：添加个人平台账号<br>
    点击【个人信息-第三方平台账号】配置 禅道 账号，创建缺陷同步可使用该账户信息。这里配置的账号也需要 超级 Model 调用接口权限。<br>
...
!!! ms-abstract ""
    - **新增缺陷模板**<br>
        ...
        点击【创建缺陷模板】按钮可新增缺陷模板，可以给用例模板帮绑定自定义字段。</br>
