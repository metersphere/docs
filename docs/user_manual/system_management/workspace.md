...
![!TAPD-关联需求](../../img/system_management/TAPD-关联需求.png)

在缺陷管理提交缺陷后，数据会同步到TAPD系统中。

![!TAPD-同步需求](../../img/system_management/TAPD-同步需求.png)
...
![!禅道-相关需求](../../img/system_management/禅道-相关需求.png)

在缺陷管理提交缺陷后，数据会同步到禅道系统中。

![!禅道-同步需求](../../img/system_management/禅道-同步需求.png)
