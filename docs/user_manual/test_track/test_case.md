...
##### <font size=4> 依赖关系视图 </font>
设置前后置测试用例后，系统支持以图表的形式显示测试用例关系图。点击“依赖关系图”。
![!依赖关系视图](../../img/track/依赖关系视图1.png)

![!依赖关系视图](../../img/track/依赖关系视图2.png)
...
### 自定义列表显示信息
功能详细介绍及使用说明见 [通用功能->自定义列表显示](../../general/#_12)。
![!自定义列表显示信息](../../img/track/自定义列表显示信息.png)

### 列表头功能
功能详细介绍及使用说明见 [通用功能->自定义列表显示](../../general/#_8)。
