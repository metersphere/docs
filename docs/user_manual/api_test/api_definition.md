...
![!关注接口定义](../../img/api/关注接口定义.png)

##### 接口变更日志
点击页面右上角的 `变更历史` 可查看此接口所有的变更历史详情。
![!变更历史](../../img/api/变更历史1.png)

点击 `查看详情` 可查看具体变更信息。
![!变更历史](../../img/api/变更历史2.png)
...
##### 依赖关系
接口定义支持设置接口的前后置依赖关系。
![!依赖关系](../../img/api/依赖关系1.png)

点击 `添加` 按钮，可以添加前后置接口。
![!依赖关系](../../img/api/依赖关系2.png)

点击 `依赖关系图` 图标可查看依赖关系图。
![!依赖关系](../../img/api/依赖关系3.png)
