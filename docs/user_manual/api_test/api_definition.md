...
##### <font size=4> 3.3.1.5 TCP请求 </font>
###### 请求参数
...
##### <font size=4> 3.3.1.6 SQL请求 </font>
...
##### <font size=4> 3.3.1.7 DUBBO请求 </font>
###### Interface
...
##### <font size=4> 3.3.2.3 执行结果 </font>
在响应内容中展示响应体、响应头、请求内容、控制台、断言和提取参数等信息。
![!执行结果](../../img/api/执行结果.png)

##### <font size=4> 3.3.2.4 其他管理功能 </font>
...
#### <font size=4> 3.3.3 CASE </font>
在CASE页面中展示当前接口定义下的所有接口用例列表。
##### <font size=4> 3.3.3.1 列表功能 </font>
...
##### <font size=4> 3.3.4.2 TCP Mock设置 </font>
###### 开启TCP Mock服务
