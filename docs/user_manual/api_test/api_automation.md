...
### 5.1 导入
!!! ms-abstract ""
    场景支持导入 MeterSphere、JMeter 格式的文件。
![!功能操作](../../img/api_test/api_automation/功能列表导入功能.png){ width="900px" }

!!! ms-abstract "导入模式"

    - **【覆盖】** 系统已存在同一场景则进行覆盖导入。
    - **【不覆盖】** 系统已存在的同一场景(模块下名称唯一)，则不做变更；若系统不存在的场景，则新增。

### 5.2 导出
!!! ms-abstract ""
    勾选场景后，点击导出按钮，开启保留引用关系后进行导出，页面提示导出成功后，点击“下载文件”即可下载压缩包。
![!功能操作](../../img/api_test/api_automation/功能列表导出功能.png){ width="900px" }

![!功能操作](../../img/api_test/api_automation/功能列表下载文件功能.png){ width="900px" }

!!! ms-abstract "保留引用关系说明"

    - **【开启】** 关闭：导出引用和复制的步骤处理为自定义请求。
    - **【关闭】** 系统已存在的同一场景(模块下名称唯一)，则不做变更；若系统不存在的场景，则新增。

## 6 其他功能
!!! ms-abstract ""
    可对列表场景进行条件筛选、创建视图等功能。
![!功能操作](../../img/api_test/api_automation/视图刷新功能.png){ width="900px" }

!!! ms-abstract ""
    对列表场景进行【编辑】、【执行】、【复制】、【创建定时任务】、【删除】等操作。
![!功能操作](../../img/api_test/api_automation/列表功能操作.png){ width="900px" }

!!! ms-abstract ""
    批量对场景进行【全选当前页/全选所有页】、【导出】、【编辑】、【执行】、【移动到】、【复制到】、【删除】等操作。
![!功能操作](../../img/api_test/api_automation/列表批量功能操作.png){ width="900px" }