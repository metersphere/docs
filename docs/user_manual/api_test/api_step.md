...
## 9 前置脚本
与单接口用例步骤中的前置脚本类似，请参考 [前置脚本](#1-前置脚本)。

## 10 后置脚本
与单接口用例步骤中的后置脚本类似，请参考 [后置脚本](#2-后置脚本)。

## 11 前置SQL
与单接口用例步骤中的前置SQL类似，请参考 [前置SQL](#3-前置-sql)。

## 12 后置SQL
与单接口用例步骤中的后置SQL类似，请参考 [后置SQL](#4-后置-sql)。

## 13 断言规则
与单接口用例步骤中的断言规则类似，请参考 [断言规则](#5-断言规则)。

## 14 提取参数
与单接口用例步骤中的提取参数类似，请参考 [提取参数](#6-提取参数)。
