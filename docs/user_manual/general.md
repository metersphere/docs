...
!!! ms-abstract ""
    批量编辑标签属性时，可以进行【更新】、【追加】、【清空】等操作。
![!批量操作](../img/general/批量编辑标签操作.png){ width="900px" }
...
### 3.10 快捷键保存
!!! ms-abstract ""
    用例编辑页面，支持使用快捷键【Ctrl+s/Command+s】进行保存操作。
...
### 6.1 系统即时任务
!!! ms-abstract ""
    点击【系统即时任务】查看运行中的【接口用例】和【接口场景】任务，点击【任务ID】查看用例详情，点击【执行结果】查看报告详情。
![!消息通知](../img/general/实时任务.png){ width="900px" }

!!! ms-abstract ""
    失败用例或场景支持一键失败重跑。
![!消息通知](../img/general/一键重跑.png){ width="900px" }


### 6.2 任务执行详情
!!! ms-abstract ""
    点击【任务执行详情】查看运行中的任务的详细情况和执行结果。
![!消息通知](../img/general/任务执行详情.png){ width="900px" }

### 6.3 系统后台任务
!!! ms-abstract ""
    点击【系统后台任务】查看定时任务，点击【任务ID】查看用例详情，可开启/关闭定时任务，点击【删除】按钮删除定时任务。
![!消息通知](../img/general/系统后台任务.png){ width="900px" }
