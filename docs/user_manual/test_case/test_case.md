...
!!! ms-abstract ""
    可根据【视图】中我关注的、我创建的以及新建视图来筛选展示的数据。
![!测试用例](../../img/track/根据视图筛选数据.png){ width="900px" }

!!! ms-abstract ""
    点击【筛选】，设置对应筛选条件筛选数据。
![!测试用例](../../img/track/筛选数据.png){ width="900px" }

![!测试用例](../../img/track/设置条件筛选数据.png){ width="900px" }
...
## 4 导入用例
!!! ms-abstract ""
    点击【导入】按钮，选择 Excel 导入，导入本地用例，下载 Excel 模板按照模板字段填写用例，导入到平台。
![!导入测试用例](../../img/track/导入按钮.png){ width="900px" }

!!! ms-abstract ""
    选择 Xmind 导入，导入本地用例，下载 Xmind 模板按照模板字段填写用例，导入到平台。
...
!!! ms-abstract "注意：使用 AI 生成用例需要先在【系统设置】-【系统参数】-【模型设置】或者登录用户的【个人中心】-【模型设置】处配置并开启模型。"
    在用例列表模式下，点击【AI生成】，打开 AI 对话页面。 点击对话框【设置】可以自主配置用例模版和设计方法
![!用例AI生成页面](../../img/track/用例AI生成页面.png){ width="900px" }
![!AI对话框设置页面](../../img/track/AI对话框设置页面.png){ width="900px" }

!!! ms-abstract ""
    输入用例要求，待AI 助手生成用例后，可以勾选用例，点击【同步用例】并选择模块，将 AI 生成用例同步至用例列表。
![!AI用例同步](../../img/track/AI用例同步.png){ width="900px" }
![!AI用例同步成功](../../img/track/AI用例同步成功.png){ width="900px" }
