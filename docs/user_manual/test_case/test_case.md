...
!!! ms-abstract ""
    ...
    进入【用例管理-功能用例】界面，点击【创建用例】新建测试用例。
...
##  2 用例更多操作
!!! ms-abstract ""
    在用例列表中，点击用例ID，可对用例设置关联用例、需求、缺陷、依赖关系信息，并查看评审、评论、变更历史等信息。
...
!!! ms-abstract "操作说明"
     ...
     - 【需求】：为当前用例关联需求信息，可以关联第三方平台需求，使用前需在【项目管理-应用设置-用例管理】配置第三方平台需求信息 。参考 [项目-关联需求](../project_management/project_permissions.md#22)。 </br>   
