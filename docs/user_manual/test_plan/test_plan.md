...
### 1.4 其他功能
!!! ms-abstract ""
    根据 ID、用例名称、所属模块、测试点等条件进行筛选
![!测试计划](../../img/test_plan/plan/测试计划筛选.png){ width="900px" }

!!! ms-abstract ""
    根据条件筛选内容后，保存为自定义视图。
![!测试计划](../../img/test_plan/plan/测试计划的视图.png){ width="900px" }

![!测试计划](../../img/test_plan/plan/自定义视图功能.png){ width="900px" }
