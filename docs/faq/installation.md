...
到 github 源码上 https://github.com/metersphere/metersphere/tree/v2.3.1/system-setting/backend/src/main/resources/db/migration
...
## 41 安装或者升级至 1.20.0 版本 及之后，做接口测试时，页面卡在加载状态，按 F12 可以看到 websocket 连接失败
```
