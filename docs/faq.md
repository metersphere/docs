...
和同属飞致云旗下的JumpServer 开源堡垒机一样，MeterSphere 的核心功能全部开源，永久免费使用。

MeterSphere 企业版包括两部分的内容，X-Pack增强包和企业级支持服务。其中，X-Pack 增强包包括一些企业级客户所需的附加功能，比如 Logo 和主题自定义配置、配额管理等，具体功能会持续增加。