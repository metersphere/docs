...
!!! ms-abstract ""
    ...
    【注意】如果升级版本跨度较大：如 V1.x-lts 升级至 V2.x-lts 版本，由于跨多版本新增功能较多，且 v2.8.1 之后docker 使用版本升级，升级过程建议按照升级指南操作升级： [MeterSphere 企业版1.20 LTS 至2.10 LTS 升级指南](https://kb.fit2cloud.com/?p=9a46f075-5cfe-46de-81f8-ab5278699697)。如果升级版本跨度不大，则按照下面说明升级即可。
